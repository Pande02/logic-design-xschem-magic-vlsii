...
C {devices/vsource.sym} -100 30 0 0 {name=V1 value="PULSE(0 1.8 2NS 2NS 2NS 50NS 100NS 5)" savecurrent=false}
...
C {devices/code_shown.sym} 170 70 0 0 {name=s1 only_toplevel=false value="
.option wnflag=o
.option savecurrents
.control
save all
